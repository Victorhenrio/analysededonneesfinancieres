...
def benchmark(nb_crypto):
    ...
    dict_crypto_nlp ={}
    dict_crypto_nlp = {"name":liste_crypto[:nb_crypto], "list_norm_average_senti":list_norm_average_senti, "liste_polarity": liste_average_senti}
    df_cryto_nlp = pd.DataFrame(dict_crypto_nlp)
