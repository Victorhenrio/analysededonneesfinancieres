...
def insert_data_to_mongo(df_cryto_data):
    
    client = pymongo.MongoClient("mongodb+srv://admin:toto@cluster0.odyjd.mongodb.net/?retryWrites=true&w=majority")
    db = client['test']
    collection = db['crypto4']
